...
## [1.3.0](https://github.com/zkbusiness/hardhat-zksync/compare/@matterlabs/hardhat-zksync-solc-v1.2.5...@matterlabs/hardhat-zksync-solc-v1.3.0) (2024-12-10)
...
* add gnu toolchain for linux as default from compiler version 1.5.3 ([#1354](https://github.com/zkbusiness/hardhat-zksync/issues/1354)) ([448a2ce](https://github.com/zkbusiness/hardhat-zksync/commit/448a2ceb6141e519e4d00a41edbf3381b282e128))
* add mock extension for compiler path remote origins ([#824](https://github.com/zkbusiness/hardhat-zksync/issues/824)) ([14e3e80](https://github.com/zkbusiness/hardhat-zksync/commit/14e3e80df60cc74ae2c26f6bfa487b17bd212f73))
* add suppressed errors and warnings ([#1375](https://github.com/zkbusiness/hardhat-zksync/issues/1375)) ([a0bf6e5](https://github.com/zkbusiness/hardhat-zksync/commit/a0bf6e57c17b063b292e26acfa8bf8f8d1974644))
* adjust solc message for missing libraries ([#783](https://github.com/zkbusiness/hardhat-zksync/issues/783)) ([aa2b48b](https://github.com/zkbusiness/hardhat-zksync/commit/aa2b48b98d5fc11570161a6b7cdfa1944ef5e8a4))
...
* introduce forceContrectsToCompile to ensure that contracts not present in the source path are compiled ([#1290](https://github.com/zkbusiness/hardhat-zksync/issues/1290)) ([fcbcd1f](https://github.com/zkbusiness/hardhat-zksync/commit/fcbcd1f56fd66be02af8fd60358656327521093e))
* make compilationJobs argument optional at TASK_COMPILE_SOLIDITY_GET_SOLC_BUILD subtask ([#1322](https://github.com/zkbusiness/hardhat-zksync/issues/1322)) ([6877903](https://github.com/zkbusiness/hardhat-zksync/commit/68779035a5f611593331f6063a9d7f8b8f07a899))
* return default zksolc version of fetching fails ([#1438](https://github.com/zkbusiness/hardhat-zksync/issues/1438)) ([b5e4582](https://github.com/zkbusiness/hardhat-zksync/commit/b5e4582c36ad79a809778bfaf29e83549668c1d6))
* set zksolc compiler version for specified compiler path ([#804](https://github.com/zkbusiness/hardhat-zksync/issues/804)) ([7d2aa6c](https://github.com/zkbusiness/hardhat-zksync/commit/7d2aa6cd180d601161af0399bd8fad884f598683))
* update fallback era compiler version to proper format ([#1446](https://github.com/zkbusiness/hardhat-zksync/issues/1446)) ([c41dbcd](https://github.com/zkbusiness/hardhat-zksync/commit/c41dbcd193f97296420061756c73160f078fb7b9))
